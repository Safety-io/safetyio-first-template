                    ...
                    <div class="w-full px-4 md:w-1/2 lg:w-1/3">
                        <div class="mb-5 flex lg:mb-0">
                            ...
                            <div>
                                ...
                                <p class="text-base font-medium text-[#C1CCF2]">
                                    26 Av. Matobo C. Lido/Golf <br> Q. Lubumbashi
                                </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="w-full px-4 md:w-1/2">
                                <div class="mb-7">
                                    <input
                                        ...
                                        class=" w-full border border-form-stroke bg-white py-4 px-6 placeholder-[#9699A6] shadow-input outline-none focus:border-green"
                                    />
                                </div>
                            </div>
                            <div class="w-full px-4">
